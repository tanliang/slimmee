...
const Section = (props) => {
  ...
  const styleSection = [...{}, { backgroundColor: sectionTintColor }];
  ...
  const styleSectionInnerBorder = props.sectionInnerBorder ? styles.section_inner : '';
  ...
  return (
    <View style={styleSection}>
      ...
      <View style={styleSectionInnerBorder}>
...
Section.propTypes = {
  ...
  sectionInnerBorder: PropTypes.bool,
